...
void buildModelOneLayer(FFN<NegativeLogLikelihood<>, RandomInitialization>& model,
 ...
 *
 */
void buildModelTwoLayers(FFN<NegativeLogLikelihood<>, RandomInitialization>& model,
                         const int sizeInputLayer,
                         const int totalClasses)
{
  // The number of neurons in the first layer.
...
int main () {
  ...
  // get rid of the header (in Armadillo representation it's the first column)
